...
double fx3(double x){ return pow(M_E, x) + pow(2, -x) + 2 * cos(x) - 6;}
double fx7(double x){ return pow(x,3) + 3 * pow(x,2) - 1;}
double fx8(double x){ return pow(x,2) - 4 * x + 4 - log(x);}
double fx10(double x){ return x + log(x);}

int main()
{
  printf("Resultado = %lf\n", metodo_da_poscCao_falsa(&fx3, 1, 2, 0.0001));
  printf("Resultado = %lf\n", metodo_da_poscCao_falsa(&fx7, -3, -2, 0.00001));
  printf("Resultado = %lf\n", metodo_da_poscCao_falsa(&fx8, 1, 2, 0.0001));
  printf("Resultado = %lf\n", metodo_da_poscCao_falsa(&fx10, 0.2, 2, 0.00001));
